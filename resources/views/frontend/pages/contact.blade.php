        ...
        <div class="container position-relative pt-6 pt-lg-7">
            <div class="row">
                <div class="col-lg-8 col-md-10">
                    ...
                    <p class="mb-7 pe-lg-9 lead">Do you have questions about our products or need a quote? Use the
        ...
        <div class="container py-9 py-lg-11">
            <div class="row mb-9 mb-lg-11 justify-content-center">
                <div class="col-lg-5 mb-5 mb-lg-0 text-center">
                    ...
                    <a href="mailto:support@ducodes.com" class="btn btn-sm btn-light shadow-sm">
