<div class="theme-panel">
    ...
    <div class="theme-panel-content" data-scrollbar="true" data-height="100%">
        ...
        <div class="theme-version">
            <div class="theme-version-item">
                <a href="index-2.html" class="theme-version-link active">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/default.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/transparent/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/transparent.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/apple/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/apple.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/material/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/material.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/facebook/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/facebook.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/google/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/google.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
        </div>
        ...
        <div class="theme-version">
            <div class="theme-version-item">
                <a href="index-2.html" class="theme-version-link active">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/html.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/ajax/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/ajax.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/angularjs/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/angular1x.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/angularjs19/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/angular10x.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/svelte/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/svelte.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="javascript:alert('Laravel Version only available in downloaded version.');"
                    ...
                    <span style="background-image: url({{ asset('admincss/assets/img/version/laravel.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="javascript:alert('Django Version only available in downloaded version.');"
                    class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/django.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/vue3/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/vuejs.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/react/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/reactjs.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="javascript:alert('.NET Core MVC Version only available in downloaded version.');"
                    class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/dotnet.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/admin/nextjs/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/version/nextjs.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
        </div>
        ...
        <div class="theme-version">
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/one-page-parallax/" class="theme-version-link">
                    <span
                        style="background-image: url({{ asset('admincss/assets/img/theme/one-page-parallax.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/e-commerce/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/e-commerce.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/blog/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/blog.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/forum/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/forum.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
            <div class="theme-version-item">
                <a href="https://seantheme.com/color-admin/frontend/corporate/" class="theme-version-link">
                    <span style="background-image: url({{ asset('admincss/assets/img/theme/corporate.jpg') }});"
                        class="theme-version-cover"></span>
                </a>
            </div>
        </div>
