    ...
    <div class="app-sidebar-content" data-scrollbar="true" data-height="100%">
        ...
        <div class="menu">
            ...
            <div class="menu-item has-sub">
                <a href="javascript:;" class="menu-link">
                    <div class="menu-icon">
                        <i class="fa fa-sitemap"></i> <!-- FontAwesome icon -->
                    </div>
            ...
            <div class="menu-item ">
                <a href="bootstrap_5.html" class="menu-link">
                    <div class="menu-icon-img">
                        <img src="admincss/assets/img/logo/logo-bs5.png" alt="" />
                    </div>
            ...
            <div class="menu-item has-sub">
                ...
                <div class="menu-submenu">
                    ...
                    <div class="menu-item">
                        <a href="https://seantheme.com/color-admin/admin/nextjs/" class="menu-link">
                            <div class="menu-text">NEXTJS <i class="fa fa-paper-plane text-theme"></i></div>
                        </a>
                    </div>
                    <div class="menu-item">
