...
<head>
	...
	<!-- ================== BEGIN core-css ================== -->
	<link href="admincss/assets/css/vendor.min.css" rel="stylesheet" />
	<link href="admincss/assets/css/default/app.min.css" rel="stylesheet" />
    <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons/font/bootstrap-icons.css" rel="stylesheet" />
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css" rel="stylesheet" />
	<!-- ================== END core-css ================== -->

	<!-- ================== BEGIN page-css ================== -->
	<link href="admincss/assets/plugins/jvectormap-next/jquery-jvectormap.css" rel="stylesheet" />
	<link href="admincss/assets/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.css" rel="stylesheet" />
...
<body>
							...
							<div class="h-300px p-3" data-scrollbar="true">
								<div class="d-sm-flex">
									<a href="javascript:;" class="w-sm-200px">
										<img class="mw-100 rounded" src="admincss/assets/img/gallery/gallery-1.jpg" alt="" />
									</a>
								...
								<div class="d-sm-flex">
									<a href="javascript:;" class="w-sm-200px">
										<img class="mw-100 rounded" src="admincss/assets/img/gallery/gallery-10.jpg" alt="" />
									</a>
									<div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
								...
								<div class="d-sm-flex">
									<a href="javascript:;" class="w-sm-200px">
										<img class="mw-100 rounded" src="admincss/assets/img/gallery/gallery-7.jpg" alt="" />
									</a>
									<div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
								...
								<div class="d-sm-flex">
									<a href="javascript:;" class="w-sm-200px">
										<img class="mw-100 rounded" src="admincss/assets/img/gallery/gallery-8.jpg" alt="" />
									</a>
									<div class="flex-1 ps-sm-3 pt-3 pt-sm-0">
									...
									<tbody>
										<tr>
											...
											<td class="hidden-sm text-center">
												<a href="javascript:;">
													<img src="admincss/assets/img/product/product-1.png" alt="" width="32px"  />
												</a>
											</td>
										...
										<tr>
											...
											<td class="hidden-sm text-center">
												<a href="javascript:;">
													<img src="admincss/assets/img/product/product-2.png" alt="" width="32px" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;" class="text-dark text-decoration-none">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
										...
										<tr>
											...
											<td class="hidden-sm text-center">
												<a href="javascript:;">
													<img src="admincss/assets/img/product/product-3.png" alt="" width="32px" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;" class="text-dark text-decoration-none">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
										...
										<tr>
											...
											<td class="hidden-sm text-center">
												<a href="javascript:;">
													<img src="admincss/assets/img/product/product-4.png" alt="" width="32px" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;" class="text-dark text-decoration-none">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
										...
										<tr>
											...
											<td class="hidden-sm text-center">
												<a href="javascript:;">
													<img src="admincss/assets/img/product/product-5.png" alt="" width="32px" />
												</a>
											</td>
											<td class="text-nowrap">
												<h6><a href="javascript:;" class="text-dark text-decoration-none">Nunc eleifend lorem eu velit eleifend, <br />eget faucibus nibh placerat.</a></h6>
							...
							<div class="h-300px p-3" data-scrollbar="true">
								<div class="d-flex">
									<a class="w-60px" href="javascript:;">
										<img src="admincss/assets/img/user/user-1.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
								...
								<div class="d-flex">
									<a class="w-60px" href="javascript:;">
										<img src="admincss/assets/img/user/user-2.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
									<div class="flex-1 ps-3">
								...
								<div class="d-flex">
									<a class="w-60px" href="javascript:;">
										<img src="admincss/assets/img/user/user-3.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
									<div class="flex-1 ps-3">
								...
								<div class="d-flex">
									<a class="w-60px" href="javascript:;">
										<img src="admincss/assets/img/user/user-4.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
									<div class="flex-1 ps-3">
							...
							<div class="h-300px p-3" data-scrollbar="true">
								<div class="d-flex">
									<a href="javascript:;" class="w-60px">
										<img src="admincss/assets/img/user/user-5.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
									<div class="flex-1 ps-3">
										<h5>John Doe</h5>
								...
								<div class="d-flex">
									<a href="javascript:;" class="w-60px">
										<img src="admincss/assets/img/user/user-6.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
									<div class="flex-1 ps-3">
										<h5>Terry Ng</h5>
								...
								<div class="d-flex">
									<a href="javascript:;" class="w-60px">
										<img src="admincss/assets/img/user/user-8.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
									<div class="flex-1 ps-3">
										<h5>Fiona Log</h5>
								...
								<div class="d-flex">
									<a href="javascript:;" class="w-60px">
										<img src="admincss/assets/img/user/user-7.jpg" alt="" class="mw-100 rounded-pill" />
									</a>
									<div class="flex-1 ps-3">
										<h5>John Doe</h5>
		...
		<div class="theme-panel">
			...
			<div class="theme-panel-content" data-scrollbar="true" data-height="100%">
				...
				<div class="theme-version">
					<div class="theme-version-item">
						<a href="index-2.html" class="theme-version-link active">
							<span style="background-image: url(admincss/assets/img/theme/default.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/transparent/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/transparent.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/apple/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/apple.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/material/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/material.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/facebook/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/facebook.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/google/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/google.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
				</div>
				<!-- END theme-version -->
				...
				<div class="theme-version">
					<div class="theme-version-item">
						<a href="index-2.html" class="theme-version-link active">
							<span style="background-image: url(admincss/assets/img/version/html.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/ajax/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/ajax.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/angularjs/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/angular1x.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/angularjs19/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/angular10x.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/svelte/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/svelte.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="javascript:alert('Laravel Version only available in downloaded version.');" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/laravel.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="javascript:alert('Django Version only available in downloaded version.');" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/django.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/vue3/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/vuejs.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/react/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/reactjs.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="javascript:alert('.NET Core MVC Version only available in downloaded version.');" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/dotnet.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/admin/nextjs/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/version/nextjs.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
				</div>
				<!-- END theme-version -->
				...
				<div class="theme-version">
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/frontend/one-page-parallax/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/one-page-parallax.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/frontend/e-commerce/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/e-commerce.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/frontend/blog/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/blog.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/frontend/forum/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/forum.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
					<div class="theme-version-item">
						<a href="https://seantheme.com/color-admin/frontend/corporate/" class="theme-version-link">
							<span style="background-image: url(admincss/assets/img/theme/corporate.jpg);" class="theme-version-cover"></span>
						</a>
					</div>
				</div>
				<!-- END theme-version -->
	...
	<!-- ================== BEGIN core-js ================== -->
	<script src="admincss/assets/js/vendor.min.js" ></script>
	<script src="admincss/assets/js/app.min.js" ></script>
	<!-- ================== END core-js ================== -->

	<!-- ================== BEGIN page-js ================== -->
        <script src="admincss/assets/plugins/gritter/js/jquery.gritter.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.canvaswrapper.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.colorhelpers.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.saturated.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.browser.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.drawSeries.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.uiConstants.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.time.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.resize.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.pie.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.crosshair.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.categories.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.navigate.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.touchNavigate.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.hover.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.touch.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.selection.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.symbol.js" ></script>
        <script src="admincss/assets/plugins/flot/source/jquery.flot.legend.js" ></script>
        <script src="admincss/assets/plugins/jquery-sparkline/jquery.sparkline.min.js" ></script>
        <script src="admincss/assets/plugins/jvectormap-next/jquery-jvectormap.min.js" ></script>
        <script src="admincss/assets/plugins/jvectormap-content/world-mill.js" ></script>
        <script src="admincss/assets/plugins/bootstrap-datepicker/dist/js/bootstrap-datepicker.js" ></script>
        <script src="admincss/assets/js/demo/dashboard.js" ></script>
	<!-- ================== END page-js ================== -->
...
{{-- <script src="../../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="b8ed6ea96f800e4936bd56c3-|49" defer></script> --}}
