                                    ...
                                    <div class="col-lg-3">
                                        <div class="h-100">
                                            <div>
                                                ...
                                                <a class="dropdown-item" href="component-call-to-action.html">Call to
                                                    action</a>
                                                <a class="dropdown-item" href="component-bs-carousel.html">Carousel
                                                    bootstrap</a>
                                        ...
                                        <div class="h-100">
                                            <div>
                                                ...
                                                <a class="dropdown-item" href="component-dropdown-grid.html">Dropdown
                                                    Grid</a>
                                                <a class="dropdown-item" href="component-form-components.html">Form
                                                    components</a>
                                                <a class="dropdown-item" href="component-form-select.html">Form
                                                    Select</a>
                                                <a class="dropdown-item" href="component-form-autosize.html">Form
                                                    Autosize</a>
                                                <a class="dropdown-item" href="component-form-steps.html">Form Steps</a>
                                                <a class="dropdown-item" href="component-form-layouts.html">Form
                                                    Layouts</a>
                                                <a class="dropdown-item" href="component-form-quill-editor.html">Form
                                                    editor</a>
                                                <a class="dropdown-item" href="component-form-flatpicker.html">Form
                                                    flatpicker</a>
                                                <a class="dropdown-item" href="component-form-validation.html">Form
                                                    validation</a>
                                                <a class="dropdown-item" href="component-grid-system.html">Grid
                                                    system</a>
                                                <a class="dropdown-item" href="component-gsap-reveal.html">Gsap
                                                    Reveal</a>
                                                <a class="dropdown-item" href="component-icons-bootstrap.html">Icons
                                                    Bootstrap</a>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="h-100">
                                            <div>
                                                ...
                                                <a class="dropdown-item" href="component-icons-social-brands.html">Icons
                                                    Social</a>
                                                <a class="dropdown-item" href="component-isotope-filter.html">Isotope
                                                    filter</a>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="h-100">
                                            <div>
                                                ...
                                                <a class="dropdown-item" href="component-shapes-dividers.html">Shapes &
                                                    dividers</a>
                                                <a class="dropdown-item" href="component-tabbbed-content.html">Tabbed
                                                    Content</a>
                                                ...
                                                <a class="dropdown-item"
                                                    href="component-testimonials.html">Testimonials</a>
                                                ...
                                                <a class="dropdown-item" href="component-utility-classes.html">Utility
                                                    classes</a>
                                                <a class="dropdown-item" href="component-video-plyr.html">Video
                                                    Player</a>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="dropdown-scroll-lg">
                                <div class="row mx-lg-0">
                                    <div class="col-lg-4 mb-4 mb-lg-0">
                                        ...
                                        <div class="row g-0">
                                            <div class="col-lg-6">
                                                ...
                                                <a href="header-absolute-top.html" class="dropdown-item">Absolute
                                                    top</a>
                                                ...
                                                <a href="header-sticky-fixed.html" class="dropdown-item">Sticky
                                                    fixed</a>
                                                <a href="header-sticky-boxed.html" class="dropdown-item">Sticky
                                                    Boxed</a>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a href="header-search-bar-3.html" class="dropdown-item">Search 3</a>

                                                <a href="header-search-with-icons.html" class="dropdown-item">Icons</a>
                                                <a href="header-shopping-cart.html" class="dropdown-item">Shopping
                                                    Cart</a>
                                                <a href="header-shopping-cart-2.html" class="dropdown-item">Shopping
                                                    Cart 2</a>
                                                <a href="header-offcanvas.html" class="dropdown-item">offcanvas</a>
                                                <a href="header-offcanvas-collapse.html"
                                                    class="dropdown-item position-relative text-truncate pe-4">offcanvas
                                                    collapse</a>
                                                <div class="dropdown-divider mx-3"></div>
                                                <div class="dropdown-header">Footer Styles <span
                                                        class="badge ms-2 bg-info">9+</span></div>
                                    ...
                                    <div class="col-lg-5 mb-4 mb-lg-0">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                ...
                                                <a href="hero-parallax-element.html" class="dropdown-item"> Parallax
                                                    Element</a>
                                                ...
                                                <a href="hero-youtube-video.html" class="dropdown-item">Youtube
                                                    Video</a>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <a href="hero-shape-image-2.html" class="dropdown-item">Shape Image
                                                    2</a>
                                                <a href="hero-tiles.html" class="dropdown-item">Image tiles</a>
                                                <a href="hero-media-player.html" class="dropdown-item">Media Player </a>
                                                ...
                                                <a href="hero-slider-swiper.html" class="dropdown-item">Swiper
                                                    slider</a>
                                                <a href="hero-slider-master.html" class="dropdown-item">Master
                                                    Slider</a>
                                                <a href="hero-slider-master-alt.html" class="dropdown-item">Master
                                                    Slider Alt</a>
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <a class="dropdown-item" href="layout-secondary-navbar.html">Secondary
                                            Navbar</a>
                                        <div class="dropdown-divider mx-3"></div>
                                        <h5 class="dropdown-header mb-lg-2">
                                            Theme styles</h5>
                                        <a class="d-flex align-items-center dropdown-item"
                                            href="theme-style-default.html">
                                            <span
                                                class="d-inline-block align-middle me-2 rounded-circle shadow-lg lh-1">
                                                <svg width="16" height="16" class="align-middle" viewBox="0 0 10 10"
                                        ...
                                        <a class="d-flex align-items-center dropdown-item"
                                            href="theme-style-serif.html">
                                            <span
                                                class="flex-center font-serif width-1x small height-1x me-2 rounded-circle shadow-lg lh-1">
                                                s
                                            </span> Theme Serif
                                        </a>

                                        <a class="d-flex align-items-center dropdown-item"
                                            href="theme-style-orange.html">
                                            <span
                                                class="d-inline-block align-middle me-2 rounded-circle shadow-lg lh-1">
                                                <svg width="16" height="16" class="align-middle" viewBox="0 0 10 10"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <a class="d-flex align-items-center dropdown-item" href="theme-style-rtl.html">
                                            <span
                                                class="flex-center fw-bold bg-success text-white width-1x small height-1x me-2 rounded-circle shadow-lg lh-1">
                                                R
                                            </span> Theme RTL
                                        </a>
                                    </div>
